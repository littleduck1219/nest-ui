...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-HPYQSIAR.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-V7TOUAQD.js"), act = await getAct();
...
//# sourceMappingURL=chunk-DTNRQVTV.js.map
