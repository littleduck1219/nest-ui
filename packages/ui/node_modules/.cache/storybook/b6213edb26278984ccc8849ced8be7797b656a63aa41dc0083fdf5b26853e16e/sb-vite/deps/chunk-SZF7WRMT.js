import {
  ...
  __export,
  __toESM as __toESM2
} from "./chunk-TZPMROJM.js";
import {
  require_react
} from "./chunk-NRC5Z7CG.js";
import {
  require_global
...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-QPXKEC3R.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-JL2LIO4K.js"), act = await getAct();
...
//# sourceMappingURL=chunk-SZF7WRMT.js.map
